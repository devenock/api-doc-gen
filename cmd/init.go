...
var initCmd = &cobra.Command{
	...
	Long:         `Create a configuration file (.specyl.yaml) in the current directory.`,
	RunE:         runInit,
	Example:      `  specyl init`,
	SilenceUsage: true,
}
...
func runInit(cmd *cobra.Command, args []string) error {
	...
	defaultConfig := fmt.Sprintf(`# Specyl Configuration
# Generated by specyl
...
`
	...
	fmt.Println("You can now customize the configuration and run 'specyl generate'")
	return nil
}
