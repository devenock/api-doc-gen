// Package cmd implements the specyl CLI (Cobra commands, flag/config
...
//
//	go build -ldflags "-X github.com/devenock/specyl/cmd.version=vX.Y.Z"
//
...
// wasn't set (e.g. the binary came from `go install .../specyl@vX.Y.Z`)
